...
export default function GeminiAssistant({ mode, onClose, onApply }) {
  ...
  function getModeWelcome(m) {
    const welcomes = {
      ...
      resumevault_character: "Tell me the kind of ResumeVaultGod spokesperson you want: recruiter, career coach, tech mentor, founder, or job seeker. I will turn it into a realistic character brief for AI images and videos.",
  ...
  */
      ...
      setMessages(prev => [...prev, {
        role: 'assistant',
        content: fallbackText || `Sorry, I encountered an error: ${error.message}. Please try again.`,
        timestamp: new Date(),
      }]);
    } finally {
      setLoading(false);
